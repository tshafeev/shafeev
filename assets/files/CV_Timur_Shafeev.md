...
shafeev@gmail.com · LinkedIn · Saint Petersburg, Russia · Remote/Hybrid
...
- **GitOps & Continuous Delivery:** Argo CD, GitOps workflows, declarative deployments, drift detection and reconciliation, progressive rollouts
...
- Operated GitOps-based delivery with Argo CD, managing declarative application manifests and Helm releases across environments
...
**Stack:** AWS (EKS, EC2, RDS, S3), Kubernetes, Argo CD, GitLab CI/CD, Terraform, Helm
...
**Stack:** AWS (EKS, EC2, RDS, S3, Lambda), Kubernetes, Argo CD, Terraform, Helm, Cloudflare, Prometheus, Grafana
...
English · Professional | German · Basic | Russian · Native
